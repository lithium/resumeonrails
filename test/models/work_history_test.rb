...
class WorkHistoryTest < ActiveSupport::TestCase
  test "shouldn't save without company" do
  ...
  test "shouldn't save without position" do
    work_history = WorkHistory.new
  ...
  test "shouldn't save without start_date" do
    work_history = WorkHistory.new
    work_history.company = "Acme"
    work_history.position = "Pencil Pusher"
  ...
  test "shouldnt save with overlapping dates" do
